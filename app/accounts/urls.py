...
from .views import CustomLoginView, CustomLogoutView, crear_usuario, cambiar_contrasena_usuario, lista_usuarios, \
    cambiar_contraseña, ListTeamsView, DispositivosEquipoView, CrearDispositivoView, EditarDispositivoView, \
...
urlpatterns = [
    ...
    path('equipo/<int:equipo_id>/dispositivos/<int:pk>/editar/',EditarDispositivoView.as_view(),name='editar_dispositivo'),
