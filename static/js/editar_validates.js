...
const superMatrizId = contentWrapper.dataset.supermatrizId;
const actualizarEstadoUrl = contentWrapper.dataset.actualizarUrl;
const csrfToken = contentWrapper.dataset.csrfToken;
